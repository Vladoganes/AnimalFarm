...
public class Experiment {
    ...
    public String[] makeStepAndGetFarmStatTableInfo() {
        ...
        if (!farm.isBankrupt()) {
            ...
            return farm.makeYearModellingAndGetInfoForStatTable(
    ...
    public void setCurrentYearContract(
        ...
        contracts.insertAndCreateContractBy(
                currentYear,
